...
const Product = () => {
    ...
    return (
        <div className="container my-4">
            ...
            <h1 className="text-center pt-5">Latest Products</h1>
            <hr></hr>
                ...
                <div key={product.id} className="col-lg-4 col-md-6 col-sm-12 p-3">
                 ...
                 <div className="card h-100 shadow-sm my-3 overflow-visible">
                     ...
                     <div className="card-body text-center">
                        ...
                        <button className="btn btn-dark border-2" onClick={ () => {dispatch(addToCart(product)) ; toast.success("Item added to cart!") }}>Add To Cart</button>
                     </div>
...
// clicking "Buy Now" will take the user to /product/:id, which loads ProductDetails.
